model_path = './model_face_expression/checkpoint.ckpt'
...
emotionnet = tf.keras.models.load_model(model_path)
scale_factor = 1.2
min_neighbors = 3
min_size = (50, 50)
webcam=True 
class_names = os.listdir('./images/images/train')
    ...
    while True:
        ...
        if len(rects) >= 0:
            ...
            for (x, y, w, h) in rects:
                ...
                pred = emotionnet.predict(tf.expand_dims(image_to_predict,axis=0))                
